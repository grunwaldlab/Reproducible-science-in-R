...
invisible(gloss("flat text file", paste0("a text file to hold data in a tabular format, ",
  "where cells are separated by a common character such as comma or tab. ",
  "Common formats are csv and tsv")))
```
...
## How should I format my data?
 ...
 - Data in cells
 - Saved as a flat text file (e.g. `.csv`, `.tsv`, `.txt`)
