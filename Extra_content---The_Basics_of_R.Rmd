...
Here we are telling R to read a table from the file "ComasOxapampa.csv" that is 
in the folder called "ex\_data" using the `r gloss("function", function_def)`
`read.table()` (more on functions in the next section). What we get back is a
