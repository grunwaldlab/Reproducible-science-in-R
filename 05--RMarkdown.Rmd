...
`r step('Replicate the rest of the AUDPC analysis. Combine the content of "original_audpc_report.docx" and "original_audpc_code.R" to recreate "audpc_report_to_replicate.html"')`

This will involve combining text from `original_audpc_report.docx` and code from `original_audpc_code.R` in a new Rmarkdown document.
...
We have placed an example of a reproducible analysis of the population genetic
structure of *Phytophthora infestans* at
