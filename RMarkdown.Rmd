...
Imagine you find one small mistake in a data point.
In RMarkdown you change the data point and just render the document again and all changes will be ported through to every intermediate and final analyses.
...
There are two ways to add R code to Markdown: namele as inline or as code chunks.
...
Following, we will work with RMarkdwon to learn the basic syntax and work through a set of demonstrations:
...
The R base graphics are known for their flexibility whereas ggplot2 is known for consistent syntax and aesthetics as well as the ability to crete complex graphics. 
