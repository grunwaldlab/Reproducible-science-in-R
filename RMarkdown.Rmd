...
bib_path <- file.path(output_folder_name, "bibliography.bibtex")
bib_content <-"
@article{baumer2014r,
...
Now the two files are associated with each other, but the papers are not yet cited in the RMarkdown document.
