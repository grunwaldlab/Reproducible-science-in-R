...
Reproducible science or research provide the ability to replicate research results from a published study. This idea ultimately also includes the full computational enviroment comprising code and data to replicate the analysis `r citep("10.1126/science.1213847")`. 
